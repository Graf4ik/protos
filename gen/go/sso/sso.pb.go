...
type LoginRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Email         string                 `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`               // Auth token of the logged in user.
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x5a, 0x13, 0x67, 0x72, 0x61, 0x66, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
